...
flags.DEFINE_bool("use_checkpoints", False,
...
class NFSPPolicies(policy.Policy):
    ...
    def action_probabilities(self, state, player_id=None):
        ...
        with self._policies[cur_player].temp_mode_as(self._mode):
            p = self._policies[cur_player].step(
                info_state, is_evaluation=True).probs
        ...
        for ep in range(FLAGS.num_train_episodes):
            if ep % FLAGS.eval_every == 0:
                ...
                if FLAGS.evaluation_metric == "exploitability":
                    ...
                    logging.info(
                        "Iteration: {} Exploitability: {}".format(ep, expl))
                    ...
                    if not FLAGS.no_wandb:
                        ...
                        logging.info(
                            "Iteration: {} NashConv: {}".format(ep, nash_conv))
                else:
